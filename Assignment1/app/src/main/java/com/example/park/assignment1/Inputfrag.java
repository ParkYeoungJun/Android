 ...
 */
public class Inputfrag extends DialogFragment {
    EditText edit;
    Button ok;
    SoundPool pool;
    int congrat;
    ...
    public Dialog onCreateDialog( Bundle savedInstanceState)
    {
        ...
        View view = inflater.inflate(R.layout.inputdialog,null);
        ...
        ok.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if(edit.getText().toString().length() != 0) {
                    ...
                    Toast.makeText(getActivity(), "Please Insert Player1's Name", Toast.LENGTH_LONG).show();
